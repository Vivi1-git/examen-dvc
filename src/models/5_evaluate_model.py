...
X_test = pd.read_csv("data/processed/X_test_scaled.csv") # Chargement des données de test
y_test = pd.read_csv("data/processed/y_test.csv").values.ravel() # .ravel() pour convertir en array 1D necessaire pour sklearn
