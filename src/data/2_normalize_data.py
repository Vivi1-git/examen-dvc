...
os.makedirs("data/processed/norm", exist_ok=True)
pd.DataFrame(X_train_scaled, columns=X_train.columns).to_csv("data/processed/norm/X_train_scaled.csv", index=False)
pd.DataFrame(X_test_scaled, columns=X_test.columns).to_csv("data/processed/norm/X_test_scaled.csv", index=False)
